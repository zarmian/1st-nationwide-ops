...
export type StatTone = "blue" | "emerald" | "indigo" | "amber";
...
/**
 * Colourful KPI card for the client portal — a gradient icon chip, a soft
 * corner wash, a tinted border and a hover lift. Colour is the accent; the
 * number stays crisp and readable.
 */
