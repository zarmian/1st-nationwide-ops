...
<!-- Vendored for in-repo reference. Source: https://github.com/emilkowalski/skills
     (skills/apple-design), by Emil Kowalski. Applied to this app's UI system —
     see git history for the material chrome / press-feedback / typography pass
     and the Vaul briefing sheet. -->
