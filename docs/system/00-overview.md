...
| **Finance** | Customer billing + officer pay, snapshotted per activity; P&L and payroll. |
...
- **Prisma ORM** over **Postgres on Supabase** (EU-West / London). 36 models — see [`01-data-model.md`](./01-data-model.md).
...
```
prisma/
├── schema.prisma            # the data model (36 models, 35 enums)
